...
CREATE TABLE PILOTO (
    ...
    CONSTRAINT FK_PILOTO_PERSONA FOREIGN KEY(DNI_PERSONA) REFERENCES PERSONA(DNI)
);
...
ALTER TABLE PILOTO ADD CONSTRAINT FK_PILOTO_PROFESOR_PILOTO FOREIGN KEY(DNI_PILOTO_PROFESOR) REFERENCES PILOTO(DNI_PERSONA);
...
INSERT INTO PILOTO(DNI_PERSONA,NOVEL,TIPO_CARNET) VALUES('97504378H','NO','H2');
INSERT INTO PILOTO VALUES('23423443F','SI','H2','97504378H');
INSERT INTO PILOTO VALUES('12312312D','NO','H2','97504378H');
...
SELECT PILOTO.NOMBRE PILOTO, PROFESOR.NOMBRE PROFESOR
FROM PERSONA PROFESOR, PERSONA PILOTO, PILOTO PERSONA
WHERE PERSONA.DNI_PERSONA = PILOTO.DNI AND
PROFESOR.DNI = PERSONA.DNI_PILOTO_PROFESOR;

-- Mostrar el DNI de los distintos profesores

SELECT DISTINCT NVL(DNI_PILOTO_PROFESOR, 'SIN DNI') PROFESORES
FROM PILOTO;

-- Mostrar los carnets que tengan más de 2 personas
